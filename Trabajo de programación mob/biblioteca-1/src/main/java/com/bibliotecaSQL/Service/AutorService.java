package com.bibliotecaSQL.Service;

import com.bibliotecaSQL.Entity.Autor;
import com.bibliotecaSQL.IRepository.IAutorRepository;
import com.bibliotecaSQL.IService.IAutorService;
...
public class AutorService implements IAutorService {
    ...
    public void update(Autor autor, Long id){
        ...
        if(!autorOld.isEmpty()){
            ...
            System.out.println("No existe el autor con id dado" + id);
        }
    }
