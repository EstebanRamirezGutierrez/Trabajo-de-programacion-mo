...
import com.bibliotecaSQL.IRepository.ILibroRepository;
import com.bibliotecaSQL.IService.ILibroService;
...
public class LibroService implements ILibroService {
    ...
    public void update(Libro libro, Long id){
        ...
        if(!libroOld.isEmpty()){
            ...
            System.out.println("No existe el libro con id dado " + id);
        }
    }
